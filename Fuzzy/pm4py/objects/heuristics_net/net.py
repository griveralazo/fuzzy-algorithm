...
class HeuristicsNet:
    def __init__(self, frequency_dfg, activities=None, start_activities=None, end_activities=None,
        ...
        print("###############################")
        print(activities_occurrences)
        print("###############################")
        print(default_edges_color)
        print("###############################")
        
        print(performance_dfg)#must be checked
        print("###############################")
        print(dfg_window_2)
        print("###############################")
        print(freq_triples)
        print("###############################")
        print(net_name)#must be checked
        print("###############################")
        """
        """
    ...
    def calculate(self, dependency_thresh=defaults.DEFAULT_DEPENDENCY_THRESH,
        ...
        """
        print("###############################")
        print(dependency_thresh)
        print("###############################")
        print(and_measure_thresh)
        print("###############################")
        print(min_act_count)
        print("###############################")
        print(min_dfg_occurrences)
        print("###############################")
        print(dfg_pre_cleaning_noise_thresh)
        print("###############################")
        print(loops_length_two_thresh)
        print("###############################")
        """
        ...
        #print("dfg_pre_cleaning_noise_thresh", dfg_pre_cleaning_noise_thresh)
        if dfg_pre_cleaning_noise_thresh > 0.0:
            if self.activities is None or self.activities == []:
                self.activities = dfg_utils.get_activities_from_dfg(self.dfg)
        ...
        if self.dfg_window_2 is not None:
            #print("self.dfg_window_2: ", self.dfg_window_2)
            for el in self.dfg_window_2:
                #print(self.dfg_window_2[el])
                act1 = el[0]
                act2 = el[1]
        ...
        if self.freq_triples is not None:
            for el in self.freq_triples:
                #print(self.freq_triples)
                act1 = el[0]
                act2 = el[1]
                act3 = el[2]
                #act3 = self.dfg_window_2[el]
